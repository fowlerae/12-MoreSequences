...
def run_test_make_simple_list():
    ...
    expected = [20, 21, 22, 23, 24, 25, 261, 27, 28, 29, 30, 31, 32, 33, 34, 35]
    actual = make_simple_list(20, 35)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        ...
        corner_1 = rg.Point(center.x - radius, center.y - radius)
        corner_2 = rg.Point(center.x + radius, center.y + radius)
        rectangles = rectangles + [rg.Rectangle(corner_1,corner_2)]
    return rectangles
